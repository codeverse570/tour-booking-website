...
exports.mapFun = void 0;
var mapFun = exports.mapFun = function mapFun(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup().setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, " ").concat(loc.description)).addTo(map);
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe("pk_test_51Og1iUSJtgVpgsZdmVvzGrkZhF4s18U9X4JGMDlkb7sWJtjLwwVUDPEmKf0BIGDWDPxj268VZJa3gIxmVKShdXr400DnIsYN6U");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("/api/booking/getpaymentsession/".concat(tourId));
        case 3:
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.message === "Success") {
            (0, _alert.showAlert)('success', "changes saved!");
          }
          _context.next = 13;
          break;
        case 9:
...
var updatePassword = exports.updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(curP, Pass, cPass) {
    var res, newData;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
...
},{"./alert":"alert.js","./login":"login.js","axios":"../../node_modules/axios/index.js"}],"../../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
if (map) {
  var locations = document.getElementById("map").dataset.locations;
  locations = JSON.parse(locations);
  (0, _mapbox.mapFun)(locations);
}
var lgnoutbtn = document.querySelector(".nav__el--logout");
if (lgnoutbtn) {
  lgnoutbtn.addEventListener("click", function () {
    (0, _login.logout)();
  });
}
...
if (passwordForm) {
  ...
  passwordForm.addEventListener("submit", function (e) {
    ...
    (0, _updateUser.updatePassword)(currentPassword, Password, confirmPassword);
  });
}
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return (0, _stripe.bookTour)(e.target.dataset.tourId);
          case 3:
